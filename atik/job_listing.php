...
$getallpostssql = "SELECT * FROM posts ORDER BY post_id DESC";

if (mysqli_query($conn, $getallpostssql)) {
                                ...
                                <?php while ($row = mysqli_fetch_assoc($getallpostssqltableData)) { ?>
                                    <div class="single-job-items mb-30">
                                        ...
                                        <div class="items-link items-link2 f-right">
                                            <a
                                                href="job_details.php?status=view&&id=<?php echo $row['post_id']; ?>">View</a>
