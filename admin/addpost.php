...
if (mysqli_query($conn, $getcatquery)) {
    $tableData = mysqli_query($conn, $getcatquery);
...
if (!empty($_POST)) {
    ...
    $post_content = strval($_POST['post_content']);
    ...
    $addpostquery = "INSERT INTO posts ( post_title, post_content,post_ctg,	post_author,post_date,post_summery,author_id  )
    VALUES ('$post_title', '$post_content' , '$post_ctg' ,'$post_author','$post_date','$post_summery','$author_id')";
  ...
  EOL;
        ...
        echo "Error: " . $addpostquery . "<br>" . $conn->error;
    }
                        ...
                        <div class="card-body">
                            ...
                            <form action="addpost.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="post_summery" rows="3" required></textarea>
                                </div>

                                <button type="submit" name="add_cat" class="btn btn-primary btn-block">Add
                                    Post</button>
                            </form>
