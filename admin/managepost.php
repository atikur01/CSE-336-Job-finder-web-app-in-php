                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($tableData)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $row['post_ctg']; ?>
                                            </td>
                                            </td>
                                            <td>
                                                <?php echo $row['post_summery']; ?>
                                            </td>
                                            <td>
                                                <a class="btn btn-success"
                                                    href="editpost.php?status=edit&&id=<?php echo $row['post_id']; ?>">Edit</a>
                                                <a class="btn btn-danger"
                                                    href="?status=delete&&id=<?php echo $row['post_id']; ?>">Delete</a>
                                            </td>
                                        </tr>
